...
public class Array_List {
	...
	public static void main(String[] args) {
		...
		System.out.println(arr.lastIndexOf("Pink"));//if two same elements are there
		System.out.println(arr.contains("Green"));
		...
		//arr.toArray(); for convert list into Array
		
		
		System.out.println("List Element: "+ arr);
